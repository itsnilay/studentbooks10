<?php require_once('include/header.php');//open header ?>
                    <h1>Spindle Tree</h1>
                    ...
                    <div class="content_wrapper">
                            ...
                            <img src="img/51XAN83QT4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA300_SH20_OU01_.jpg" alt="" />
                        </div>
                        <div class="mid_column">
                            <img src="img/516mDaUzJ5L._SL500_AA300_.jpg" alt="" />
                        </div>
                        <div class="lft_border_column">
                            <img src="img/51Zy0q83ipL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA300_SH20_OU01_.jpg" alt="" />
                        </div>
