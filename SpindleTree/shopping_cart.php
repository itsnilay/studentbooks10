        ...
        <div id="cart" class="span-18 push-2 prepend-top last">
            ...
            <ul id="cart_contents" class="span-18 last">
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[0]?></div>
                ...
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[1]?></div>
                ...
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[2]?></div>
                ...
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[3]?></div>
                ...
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[4]?></div>
                ...
                <li id="cart_item" class="span-18 last">
                    ...
                    <div class="span-4 odd"><?php echo $book_prices[5]?></div>
                ...
                <div id="price" class="span-3 push-15 last">
                    <span>Total: <span id="cart_total">$23,673</span></span>
            </div>
        </div>
